...
public class ModeloERPackageImpl extends EPackageImpl implements ModeloERPackage {
	 ...
	 * @generated
	 */
	private EClass tipoDebilEClass = null;
	 ...
	 * @generated
	 */
	private EClass tipoFuerteEClass = null;
	 ...
	 * @see modeloER.ModeloERPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getAtributo_ClavePrimaria() {
	 ...
	 * @generated
	 */
	public EAttribute getAtributo_ClaveForanea() {
	 ...
	 * @generated
	 */
	public EReference getRelacion_EntidadEntidadRelacion() {
		return (EReference)relacionEClass.getEStructuralFeatures().get(-1);
	}
	 ...
	 * @generated
	 */
	public EClass getTipoDebil() {
		return tipoDebilEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getTipoFuerte() {
		return tipoFuerteEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(atributoEClass, ATRIBUTO__CLAVE_PRIMARIA);
		createEAttribute(atributoEClass, ATRIBUTO__CLAVE_FORANEA);
		...
		createEReference(relacionEClass, RELACION__ENTIDAD_ENTIDAD_RELACION);
		...
		tipoDebilEClass = createEClass(TIPO_DEBIL);

		tipoFuerteEClass = createEClass(TIPO_FUERTE);
	...
	public void initializePackageContents() {
		...
		tipoDebilEClass.getESuperTypes().add(this.getRelacion());
		...
		initEAttribute(getAtributo_ClavePrimaria(), ecorePackage.getEBoolean(), "clavePrimaria", null, 0, 1, Atributo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAtributo_ClaveForanea(), ecorePackage.getEBoolean(), "claveForanea", null, 0, 1, Atributo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRelacion_EntidadEntidadRelacion(), this.getEntidad(), null, "entidadEntidadRelacion", null, 1, 1, Relacion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDiagrama_TipodebilDelDiagrama(), this.getTipoDebil(), null, "tipodebilDelDiagrama", null, 0, -1, Diagrama.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(tipoDebilEClass, TipoDebil.class, "TipoDebil", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(tipoFuerteEClass, TipoFuerte.class, "TipoFuerte", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
