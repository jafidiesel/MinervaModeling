 ...
 * </p>
 * <ul>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getRelacionesDelDiagrama <em>Relaciones Del Diagrama</em>}</li>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getAtributosDelDiagrama <em>Atributos Del Diagrama</em>}</li>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getEntidadesDelDiagrama <em>Entidades Del Diagrama</em>}</li>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getHerenciasDelDiagrama <em>Herencias Del Diagrama</em>}</li>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getEntidadRelacionesDelDiagrama <em>Entidad Relaciones Del Diagrama</em>}</li>
 ...
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getTipodebilDelDiagrama <em>Tipodebil Del Diagrama</em>}</li>
 *   <li>{@link modeloER.modeloER.impl.DiagramaImpl#getTipofuerteDelDiagrama <em>Tipofuerte Del Diagrama</em>}</li>
...
public class DiagramaImpl extends MinimalEObjectImpl.Container implements Diagrama {
	 ...
	 * @ordered
	 */
	protected EList<RelacionTipoDebil> tipodebilDelDiagrama;
	 ...
	 * @ordered
	 */
	protected EList<RelacionTipoFuerte> tipofuerteDelDiagrama;
	 ...
	 * @generated
	 */
	public EList<RelacionTipoDebil> getTipodebilDelDiagrama() {
		if (tipodebilDelDiagrama == null) {
			tipodebilDelDiagrama = new EObjectContainmentEList<RelacionTipoDebil>(RelacionTipoDebil.class, this, ModeloERPackage.DIAGRAMA__TIPODEBIL_DEL_DIAGRAMA);
		}
	 ...
	 * @generated
	 */
	public EList<RelacionTipoFuerte> getTipofuerteDelDiagrama() {
		if (tipofuerteDelDiagrama == null) {
			tipofuerteDelDiagrama = new EObjectContainmentEList<RelacionTipoFuerte>(RelacionTipoFuerte.class, this, ModeloERPackage.DIAGRAMA__TIPOFUERTE_DEL_DIAGRAMA);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModeloERPackage.DIAGRAMA__TIPODEBIL_DEL_DIAGRAMA:
				...
				getTipodebilDelDiagrama().addAll((Collection<? extends RelacionTipoDebil>)newValue);
				return;
			case ModeloERPackage.DIAGRAMA__TIPOFUERTE_DEL_DIAGRAMA:
				getTipofuerteDelDiagrama().clear();
				getTipofuerteDelDiagrama().addAll((Collection<? extends RelacionTipoFuerte>)newValue);
				return;
			case ModeloERPackage.DIAGRAMA__ENTIDADES_RELACIONES_FUERTES_DEL_DIAGRAMA:
