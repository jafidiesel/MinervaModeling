...
public class ModeloERSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModeloERPackage.TIPO_DEBIL: {
				TipoDebil tipoDebil = (TipoDebil)theEObject;
				T result = caseTipoDebil(tipoDebil);
				if (result == null) result = caseRelacion(tipoDebil);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModeloERPackage.TIPO_FUERTE: {
				TipoFuerte tipoFuerte = (TipoFuerte)theEObject;
				T result = caseTipoFuerte(tipoFuerte);
				if (result == null) result = caseRelacion(tipoFuerte);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tipo Debil</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tipo Debil</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTipoDebil(TipoDebil object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tipo Fuerte</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tipo Fuerte</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTipoFuerte(TipoFuerte object) {
		return null;
	}
