...
/**
 * This is the item provider adapter for a {@link modeloER.Atributo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtributoItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addClavePrimariaPropertyDescriptor(object);
			addClaveForaneaPropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addClavePrimariaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_clavePrimaria_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_clavePrimaria_feature", "_UI_Atributo_type"),
				 ModeloERPackage.Literals.ATRIBUTO__CLAVE_PRIMARIA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Clave Foranea feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addClaveForaneaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_claveForanea_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_claveForanea_feature", "_UI_Atributo_type"),
				 ModeloERPackage.Literals.ATRIBUTO__CLAVE_FORANEA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
