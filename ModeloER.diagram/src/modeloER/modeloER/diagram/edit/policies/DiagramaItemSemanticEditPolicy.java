...
public class DiagramaItemSemanticEditPolicy
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (modeloER.modeloER.diagram.providers.ModeloERElementTypes.Herencia_2008 == req.getElementType()) {
			return getGEFWrapper(new modeloER.modeloER.diagram.edit.commands.HerenciaCreateCommand(req));
		}
		if (modeloER.modeloER.diagram.providers.ModeloERElementTypes.EntidadFuerte_2009 == req.getElementType()) {
			return getGEFWrapper(new modeloER.modeloER.diagram.edit.commands.EntidadFuerteCreateCommand(req));
		}
		if (modeloER.modeloER.diagram.providers.ModeloERElementTypes.EntidadDebil_2010 == req.getElementType()) {
