...
public class DiagramaCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(modeloER.modeloER.ModeloERPackage.eINSTANCE.getDiagrama_AtributocompuestoDelDiagrama());
			myFeaturesToSynchronize
					.add(modeloER.modeloER.ModeloERPackage.eINSTANCE.getDiagrama_RelacionesTipodebilDelDiagrama());
			myFeaturesToSynchronize
			...
			myFeaturesToSynchronize
					.add(modeloER.modeloER.ModeloERPackage.eINSTANCE.getDiagrama_EntidaddebilDelDiagrama());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<modeloER.modeloER.diagram.part.ModeloERNodeDescriptor> childDescriptors = modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
				.getDiagrama_1000SemanticChildren(viewObject);
		for (modeloER.modeloER.diagram.part.ModeloERNodeDescriptor d : childDescriptors) {
	...
	*/
	private boolean isMyDiagramElement(View view) {
		int visualID = modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	*/
	protected void refreshSemantic() {
		...
		for (Iterator<modeloER.modeloER.diagram.part.ModeloERNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			modeloER.modeloER.diagram.part.ModeloERNodeDescriptor next = descriptorsIterator.next();
			String hint = modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(next.getVisualID());
		...
		for (modeloER.modeloER.diagram.part.ModeloERNodeDescriptor next : childDescriptors) {
			String hint = modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(next.getVisualID());
	...
	*/
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<modeloER.modeloER.diagram.part.ModeloERLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry
			...
			for (Iterator<modeloER.modeloER.diagram.part.ModeloERLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				modeloER.modeloER.diagram.part.ModeloERLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	...
	* @generated
	*/
	private Collection<modeloER.modeloER.diagram.part.ModeloERLinkDescriptor> collectAllLinks(View view,
		...
		case modeloER.modeloER.diagram.edit.parts.DiagramaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						modeloER.modeloER.diagram.part.ModeloERDiagramUpdater.getDiagrama_1000ContainedLinks(view));
			}
		...
		case modeloER.modeloER.diagram.edit.parts.AtributoDerivadoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getAtributoDerivado_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.ClavePrimariaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getClavePrimaria_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case modeloER.modeloER.diagram.edit.parts.ClavePrimariaForaneaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getClavePrimariaForanea_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.ClaveForaneaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						modeloER.modeloER.diagram.part.ModeloERDiagramUpdater.getClaveForanea_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.HerenciaEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						modeloER.modeloER.diagram.part.ModeloERDiagramUpdater.getHerencia_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.EntidadFuerteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getEntidadFuerte_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.EntidadDebilEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						modeloER.modeloER.diagram.part.ModeloERDiagramUpdater.getEntidadDebil_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.AtributoEntidadLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getAtributoEntidadLink_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.LinkHerenciaHijoEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getLinkHerenciaHijo_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.EntidadRelacionFuerteEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getEntidadRelacionFuerte_4003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.EntidadRelacionDebilEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getEntidadRelacionDebil_4004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.LinkASACEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(
						modeloER.modeloER.diagram.part.ModeloERDiagramUpdater.getLinkASAC_4005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.RelacionAtributoLinkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getRelacionAtributoLink_4006ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case modeloER.modeloER.diagram.edit.parts.LinkHerenciaPadreEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(modeloER.modeloER.diagram.part.ModeloERDiagramUpdater
						.getLinkHerenciaPadre_4007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	*/
	private Collection<IAdaptable> createConnections(
			Collection<modeloER.modeloER.diagram.part.ModeloERLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (modeloER.modeloER.diagram.part.ModeloERLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(nextLinkDescriptor.getVisualID()),
	...
	*/
	protected final EditPart getHintedEditPart(EObject domainModelElement, Domain2Notation domain2NotationMap,
		...
		View view = (View) domain2NotationMap.getHinted(domainModelElement,
				modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry().get(view);
		}
		return null;
