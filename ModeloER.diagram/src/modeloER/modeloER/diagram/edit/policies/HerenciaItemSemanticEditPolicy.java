 ...
 * @generated
 */
public class HerenciaItemSemanticEditPolicy
	...
	*/
	public HerenciaItemSemanticEditPolicy() {
		super(modeloER.modeloER.diagram.providers.ModeloERElementTypes.Herencia_2008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getVisualID(
					incomingLink) == modeloER.modeloER.diagram.edit.parts.LinkHerenciaPadreEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getVisualID(
					outgoingLink) == modeloER.modeloER.diagram.edit.parts.LinkHerenciaHijoEditPart.VISUAL_ID) {
