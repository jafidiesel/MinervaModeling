 ...
 * @generated
 */
public class ClavePrimariaNombreAtributoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClavePrimariaNombreAtributoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = modeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					modeloER.modeloER.diagram.providers.ModeloERElementTypes.ClavePrimaria_2002, getParserElement(),
					modeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(
							modeloER.modeloER.diagram.edit.parts.ClavePrimariaNombreAtributoEditPart.VISUAL_ID));
		}
		return parser;
	}
