 ...
 * @generated
 */
public class AtributoSimpleEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public AtributoSimpleEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new modeloER.modeloER.diagram.edit.policies.AtributoSimpleItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof modeloER.modeloER.diagram.edit.parts.AtributoSimpleNombreAtributoEditPart) {
			((modeloER.modeloER.diagram.edit.parts.AtributoSimpleNombreAtributoEditPart) childEditPart)
