 ...
 * @generated
 */
public class EntidadDebilNombreEntidadEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EntidadDebilNombreEntidadEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = modeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					modeloER.modeloER.diagram.providers.ModeloERElementTypes.EntidadDebil_2010, getParserElement(),
