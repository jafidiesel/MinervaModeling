 ...
 * @generated
 */
public class AtributoDerivadoNombreAtributoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AtributoDerivadoNombreAtributoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = modeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					modeloER.modeloER.diagram.providers.ModeloERElementTypes.AtributoDerivado_2001, getParserElement(),
