 ...
 * @generated
 */
public class RelacionAtributoLinkCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelacionAtributoLinkCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRelacionAtributoLink_4006(getContainer(), getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected void doConfigure(modeloER.modeloER.RelacionAtributoLink newElement, IProgressMonitor monitor,
