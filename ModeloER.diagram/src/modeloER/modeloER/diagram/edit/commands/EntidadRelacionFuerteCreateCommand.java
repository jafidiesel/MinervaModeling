 ...
 * @generated
 */
public class EntidadRelacionFuerteCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EntidadRelacionFuerteCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEntidadRelacionFuerte_4003(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		modeloER.modeloER.EntidadRelacionFuerte newElement = modeloER.modeloER.ModeloERFactory.eINSTANCE
				.createEntidadRelacionFuerte();
		getContainer().getEntidadesRelacionesFuertesDelDiagrama().add(newElement);
		newElement.setEntidadERLink(getSource());
		newElement.setRelacionERLink(getTarget());
	...
	* @generated
	*/
	protected void doConfigure(modeloER.modeloER.EntidadRelacionFuerte newElement, IProgressMonitor monitor,
