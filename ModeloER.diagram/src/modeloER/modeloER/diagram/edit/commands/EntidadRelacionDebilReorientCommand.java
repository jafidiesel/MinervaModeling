 ...
 * @generated
 */
public class EntidadRelacionDebilReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EntidadRelacionDebilReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof modeloER.modeloER.EntidadRelacionDebil) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntidadRelacionDebil_4004(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		modeloER.modeloER.Diagrama container = (modeloER.modeloER.Diagrama) getLink().eContainer();
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntidadRelacionDebil_4004(container, getLink(), source, getNewTarget());
	}
	...
	* @generated
	*/
	protected modeloER.modeloER.EntidadRelacionDebil getLink() {
		return (modeloER.modeloER.EntidadRelacionDebil) getElementToEdit();
	}
