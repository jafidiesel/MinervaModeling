 ...
 * @generated
 */
public class LinkASACCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public LinkASACCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateLinkASAC_4005(getContainer(), getSource(), getTarget());
	}
	...
	* @generated
	*/
	protected void doConfigure(modeloER.modeloER.LinkASAC newElement, IProgressMonitor monitor, IAdaptable info)
