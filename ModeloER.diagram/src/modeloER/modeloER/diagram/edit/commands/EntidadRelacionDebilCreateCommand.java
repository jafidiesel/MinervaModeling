 ...
 * @generated
 */
public class EntidadRelacionDebilCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EntidadRelacionDebilCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return modeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEntidadRelacionDebil_4004(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		modeloER.modeloER.EntidadRelacionDebil newElement = modeloER.modeloER.ModeloERFactory.eINSTANCE
				.createEntidadRelacionDebil();
		getContainer().getEntidadesRelacionesDebilesDelDiagrama().add(newElement);
	...
	* @generated
	*/
	protected void doConfigure(modeloER.modeloER.EntidadRelacionDebil newElement, IProgressMonitor monitor,
