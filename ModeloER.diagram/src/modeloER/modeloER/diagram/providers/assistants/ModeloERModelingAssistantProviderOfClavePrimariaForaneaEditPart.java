 ...
 * @generated
 */
public class ModeloERModelingAssistantProviderOfClavePrimariaForaneaEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget(
				(modeloER.modeloER.diagram.edit.parts.ClavePrimariaForaneaEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			modeloER.modeloER.diagram.edit.parts.ClavePrimariaForaneaEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((modeloER.modeloER.diagram.edit.parts.ClavePrimariaForaneaEditPart) targetEditPart,
				relationshipType);
	}
	...
	*/
	public List<IElementType> doGetTypesForSource(
			modeloER.modeloER.diagram.edit.parts.ClavePrimariaForaneaEditPart target, IElementType relationshipType) {
