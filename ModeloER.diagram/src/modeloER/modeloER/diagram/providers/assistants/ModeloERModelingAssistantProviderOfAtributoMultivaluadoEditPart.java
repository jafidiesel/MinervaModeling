...
public class ModeloERModelingAssistantProviderOfAtributoMultivaluadoEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget(
				(modeloER.modeloER.diagram.edit.parts.AtributoMultivaluadoEditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			modeloER.modeloER.diagram.edit.parts.AtributoMultivaluadoEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((modeloER.modeloER.diagram.edit.parts.AtributoMultivaluadoEditPart) targetEditPart,
				relationshipType);
	}
	...
	*/
	public List<IElementType> doGetTypesForSource(
			modeloER.modeloER.diagram.edit.parts.AtributoMultivaluadoEditPart target, IElementType relationshipType) {
