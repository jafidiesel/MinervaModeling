 ...
 * @generated
 */
public class ModeloERMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = modeloER.modeloER.diagram.part.ModeloERDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			modeloER.modeloER.diagram.part.ModeloERDiagramEditorUtil.selectElementsInDiagram(editor,
