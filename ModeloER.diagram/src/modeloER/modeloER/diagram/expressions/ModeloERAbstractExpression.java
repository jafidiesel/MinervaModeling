 ...
 * @generated
 */
public abstract class ModeloERAbstractExpression {
	...
	*/
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = modeloER.modeloER.diagram.part.ModeloERDiagramEditorPlugin.ID;
	...
	* @generated
	*/
	protected ModeloERAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
