...
public class EntidadItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEntidadAtributosPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Entidad Atributos feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEntidadAtributosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entidad_entidadAtributos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entidad_entidadAtributos_feature", "_UI_Entidad_type"),
				 ModeloERPackage.Literals.ENTIDAD__ENTIDAD_ATRIBUTOS,
				 true,
				 false,
				 true,
				 null,
