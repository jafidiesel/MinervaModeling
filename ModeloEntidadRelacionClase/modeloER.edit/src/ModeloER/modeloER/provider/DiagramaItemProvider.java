...
public class DiagramaItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModeloERPackage.Literals.DIAGRAMA__ATRIBUTO);
			childrenFeatures.add(ModeloERPackage.Literals.DIAGRAMA__RELACION);
			childrenFeatures.add(ModeloERPackage.Literals.DIAGRAMA__ENTIDAD_RELACION);
			childrenFeatures.add(ModeloERPackage.Literals.DIAGRAMA__ENTIDAD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModeloERPackage.Literals.DIAGRAMA__ATRIBUTO,
				 ModeloERFactory.eINSTANCE.createAtributo()));

		newChildDescriptors.add
			(createChildParameter
				(ModeloERPackage.Literals.DIAGRAMA__RELACION,
				 ModeloERFactory.eINSTANCE.createRelacion()));

		newChildDescriptors.add
			(createChildParameter
				(ModeloERPackage.Literals.DIAGRAMA__ENTIDAD_RELACION,
				 ModeloERFactory.eINSTANCE.createEntidadRelacion()));

		newChildDescriptors.add
			(createChildParameter
				(ModeloERPackage.Literals.DIAGRAMA__ENTIDAD,
