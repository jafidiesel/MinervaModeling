 ...
 * @generated
 */
public class ModeloERDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public ModeloERDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ModeloER.modeloER.diagram.navigator.ModeloERDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((ModeloER.modeloER.diagram.navigator.ModeloERDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ModeloER.modeloER.diagram.navigator.ModeloERDomainNavigatorItem((EObject) objects[i],
