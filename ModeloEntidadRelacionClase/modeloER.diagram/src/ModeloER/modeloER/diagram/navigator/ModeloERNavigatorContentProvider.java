	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ModeloER.modeloER.diagram.edit.parts.AtributoEditPart.VISUAL_ID: {
			...
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup incominglinks = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_Atributo_2001_incominglinks,
		...
		case ModeloER.modeloER.diagram.edit.parts.EntidadEditPart.VISUAL_ID: {
			...
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup outgoinglinks = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_Entidad_2002_outgoinglinks,
		...
		case ModeloER.modeloER.diagram.edit.parts.RelacionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup incominglinks = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_Relacion_2003_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					ModeloER.modeloER.diagram.part.ModeloERVisualIDRegistry
		...
		case ModeloER.modeloER.diagram.edit.parts.EntidadRelacionEditPart.VISUAL_ID: {
			...
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup target = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_EntidadRelacion_4001_target,
			...
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup source = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_EntidadRelacion_4001_source,
		...
		case ModeloER.modeloER.diagram.edit.parts.EntidadEntidadAtributosEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup target = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_EntidadEntidadAtributos_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup source = new ModeloER.modeloER.diagram.navigator.ModeloERNavigatorGroup(
					ModeloER.modeloER.diagram.part.Messages.NavigatorGroupName_EntidadEntidadAtributos_4002_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					ModeloER.modeloER.diagram.part.ModeloERVisualIDRegistry
