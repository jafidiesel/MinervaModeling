 ...
 * @generated
 */
public class EntidadRelacionCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EntidadRelacionCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return ModeloER.modeloER.diagram.edit.policies.ModeloERBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEntidadRelacion_4001(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ModeloER.modeloER.EntidadRelacion newElement = ModeloER.modeloER.ModeloERFactory.eINSTANCE
				.createEntidadRelacion();
		getContainer().getEntidadRelacion().add(newElement);
		newElement.setRelacionEntidades(getSource());
		newElement.setEntidadRelacionRelaciones(getTarget());
	...
	* @generated
	*/
	protected void doConfigure(ModeloER.modeloER.EntidadRelacion newElement, IProgressMonitor monitor, IAdaptable info)
