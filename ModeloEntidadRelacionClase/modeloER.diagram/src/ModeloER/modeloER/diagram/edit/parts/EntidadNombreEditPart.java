 ...
 * @generated
 */
public class EntidadNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EntidadNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					ModeloER.modeloER.diagram.providers.ModeloERElementTypes.Entidad_2002, getParserElement(),
