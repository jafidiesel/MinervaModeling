 ...
 * @generated
 */
public class RelacionNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					ModeloER.modeloER.diagram.providers.ModeloERElementTypes.Relacion_2003, getParserElement(),
