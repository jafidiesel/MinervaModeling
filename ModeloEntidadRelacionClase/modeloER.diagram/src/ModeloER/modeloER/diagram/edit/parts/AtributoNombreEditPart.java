 ...
 * @generated
 */
public class AtributoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					ModeloER.modeloER.diagram.providers.ModeloERElementTypes.Atributo_2001, getParserElement(),
