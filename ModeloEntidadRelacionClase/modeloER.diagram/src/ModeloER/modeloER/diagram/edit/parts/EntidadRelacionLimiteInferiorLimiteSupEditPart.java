 ...
 * @generated
 */
public class EntidadRelacionLimiteInferiorLimiteSupEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EntidadRelacionLimiteInferiorLimiteSupEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ModeloER.modeloER.diagram.edit.policies.ModeloERTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ModeloER.modeloER.diagram.providers.ModeloERElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModeloER.modeloER.diagram.providers.ModeloERParserProvider.getParser(
					ModeloER.modeloER.diagram.providers.ModeloERElementTypes.EntidadRelacion_4001, getParserElement(),
					ModeloER.modeloER.diagram.part.ModeloERVisualIDRegistry.getType(
							ModeloER.modeloER.diagram.edit.parts.EntidadRelacionLimiteInferiorLimiteSupEditPart.VISUAL_ID));
		}
		return parser;
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ModeloER.modeloER.diagram.edit.parts.ModeloEREditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
