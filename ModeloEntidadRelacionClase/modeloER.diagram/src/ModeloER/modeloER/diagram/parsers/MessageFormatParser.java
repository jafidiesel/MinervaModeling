...
package ModeloER.modeloER.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ModeloER.modeloER.diagram.part.ModeloERDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ModeloER.modeloER.diagram.part.Messages.MessageFormatParser_InvalidInputError,
