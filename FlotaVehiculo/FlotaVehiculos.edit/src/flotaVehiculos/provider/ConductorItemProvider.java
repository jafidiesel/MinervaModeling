...
/**
 * This is the item provider adapter for a {@link flotaVehiculos.Conductor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConductorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conductor_cedula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conductor_cedula_feature", "_UI_Conductor_type"),
				 FlotaVehiculosPackage.Literals.CONDUCTOR__CEDULA,
				 true,
				 false,
				 false,
	...
	protected void addFechaNacimientoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conductor_fechaNacimiento_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conductor_fechaNacimiento_feature", "_UI_Conductor_type"),
				 FlotaVehiculosPackage.Literals.CONDUCTOR__FECHA_NACIMIENTO,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FlotaVehiculosPackage.Literals.CONDUCTOR__NOMBRE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Conductor_type") + " " + conductor.getCedula();
	}
